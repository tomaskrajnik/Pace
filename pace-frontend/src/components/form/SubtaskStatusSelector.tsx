            ...
            <Listbox value={selected} onChange={onSelected}>
                <div className="relative mt-1 mb-3">
                    ...
                    <Transition
                        ...
                        leaveTo="opacity-0"
                    >
                        <Listbox.Options className="absolute z-50 mt-2 pb-2 text-base bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
        ...
        <Listbox value={selected} onChange={onSelected}>
            <div className="relative">
                ...
                <Transition
                    ...
                    leaveTo="opacity-0"
                >
                    <Listbox.Options className="absolute z-50 right-0 pb-1 text-base bg-white rounded-md shadow-lg max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
                        {subtaskStatuses.map((status, statusIdx) => (
                            <Listbox.Option
                                key={statusIdx}
                                className={({ active }) =>
